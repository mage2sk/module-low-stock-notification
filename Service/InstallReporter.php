<?php
/**
 * Standalone install + heartbeat reporter for Panth_LowStockNotification.
 *
...
namespace Panth\LowStockNotification\Service;
...
{
    public const MAGENTO_MODULE = 'Panth_LowStockNotification';
    public const COMPOSER_PACKAGE = 'mage2kishan/module-low-stock-notification';
